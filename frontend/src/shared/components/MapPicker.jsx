...
const MapPicker = ({
  ...
  // E-commerce sellers still pin a business address (for records/shipping
  // origin), but their products are never radius-filtered, so the service
  // radius control is meaningless for them.
  hideRadius = false,

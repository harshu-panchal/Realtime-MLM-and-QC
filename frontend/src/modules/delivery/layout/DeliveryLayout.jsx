...
const DeliveryLayout = () => {
  ...
  const applyFromBroadcastPayload = useCallback((payload) => {
    ...
    setActiveOrder({
      ...
      pickup: p.pickup,
      drop: dropLabel,
      distance: p.distance || "Calculating...",
      estTime: p.estTime || "Calculating...",
      value: total,
      earnings: earnings,
  ...
  const applyAvailableOrdersList = useCallback((availableOrders) => {
    ...
    setActiveOrder({
      ...
      drop: isReturnPickup
        ...
        : newOrder.address?.address || "Customer Address",
      distance: newOrder.distance || "Calculating...",
      estTime: newOrder.estTime || "Calculating...",
      value: total,
      earnings: earnings,
  ...
  return (
    <div className="h-[100dvh] bg-gray-50 text-gray-900 font-sans max-w-md mx-auto relative shadow-2xl overflow-hidden border-x border-gray-100 flex flex-col">
      ...
      <main
        ...
        style={{ paddingBottom: shouldShowBottomNav ? "3.5rem" : undefined }}
      >
        <Outlet />
      </main>
